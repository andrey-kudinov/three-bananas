...
<main>
<section class="hero"><div class="hero-copy"><p class="eyebrow">ФУТБОЛЬНАЯ БИБЛИОТЕКА</p><h1>Игра начинается<br><em>с первого шага.</em></h1><p class="hero-text">Два PDF-файла, чтобы прокачать навыки, добавить уверенности и <em>получать от игры больше.</em></p><a class="scroll-link" href="#catalog"><em>Смотреть материалы <span>↓</span></em></a></div><div class="hero-ball">${ball}<span>03</span></div></section>
...
</main><footer><span>© 2026 Андрей Кудинов</span><span>ИНН 631505816542</span><span>Сделано для красивой игры</span></footer><aside class="sticky-bar" aria-live="polite"><div><strong id="sticky-title">Выберите свой материал</strong><span id="sticky-summary">Два PDF на выбор</span></div><button id="sticky-action" type="button">Выбрать PDF <span>↓</span></button></aside>`
